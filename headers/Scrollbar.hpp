...
public:
    ...
    Scrollbar(sf::Vector2f size, sf::Vector2f position, short min_value, short max_value, short scroll_value, short scroll_length, ScrollbarPartSize part_size = ScrollbarPartSize::_16) {
    ...
    bool isSelected() {
        ...
        std::cout << "scrollbar is selected\n";
    ...
    void handleEvent(sf::Event& event) {
        ...
        std::cout << "scrollbar handle_event\n";

        if (event.type == sf::Event::MouseButtonPressed) {
            std::cout << "scrollbar mouse is pressed\n";
            ...
            std::cout << "scrollbar mouse is released\n";
            if (event.mouseButton.button == sf::Mouse::Left) {
                is_pressed = false;
            }
        }
